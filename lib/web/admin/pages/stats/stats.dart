...
import 'package:monopoly_admin/web/admin/pages/stats/login_hitory_chart.dart';
...
class _StatsState extends State<Stats> {
  ...
  void initState() {
    ...
    statsProvider.getUserCountStats(adminProvider.admin!);
    statsProvider.getMonthlyActivity(adminProvider.admin!);
  }
